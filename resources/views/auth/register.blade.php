                    ...
                    <div class="card-body p-md-2">
                        <div class="row justify-content-center">
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            ...
                                            <input type="email" id="form3Example3c"
                                                ...
                                                placeholder="enter your email" style="border-radius:25px ;" />
                                            @error('email')
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            <label class="form-label" for="form3Example4c"><i
                                                    class="bi bi-chat-left-dots-fill @error('password') is-invalid @enderror"></i>
                                                Password</label>
                                            <input type="password" id="form3Example4c"
                                                class="form-control form-control-lg py-3" name="password" required
                            ...
                            <div class="col-md-10 col-lg-6 col-xl-7 text-center  align-items-center order-1 order-lg-2">
                                ...
                                <img src="{{url('/image/signup.png')}}" class="img-fluid" alt="Sample image"
